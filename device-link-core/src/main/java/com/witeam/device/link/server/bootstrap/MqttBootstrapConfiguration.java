...
public class MqttBootstrapConfiguration implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
        ...
        if (!registry.containsBeanDefinition("com.witeam.device.link.server.bootstrap.MqttServerBootstrap")) {
            registry.registerBeanDefinition("com.witeam.device.link.server.bootstrap.MqttServerBootstrap",
